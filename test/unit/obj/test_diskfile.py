...
class TestDiskFile(unittest.TestCase):
    ...
    def test_open_no_metadata(self):
        ...
        ts = normalize_timestamp(stats.st_mtime)
    ...
    def test_fd_closed_when_diskfile_open_raises_exception_race(self):
        # do_open() succeeds but do_fstat() fails because of race
        # between GET and DELETE when multiple clients are accessing
        _m_do_open = Mock(return_value=999)
        _m_do_fstat = Mock(side_effect=OSError(errno.ENOENT,
